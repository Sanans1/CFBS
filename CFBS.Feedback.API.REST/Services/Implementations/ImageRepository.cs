...
{
    public class ImageRepository : GenericRepository<FeedbackContext, Image, ImageDTO>
    {
        public ImageRepository(FeedbackContext context, IMapper mapper) : base(context, mapper)
        {
        }
    }
}
