...
{
    public class LocationRepository : GenericRepository<FeedbackContext, Location, LocationDTO>
    {
        public LocationRepository(FeedbackContext context, IMapper mapper) : base(context, mapper)
        {
        }
    }
}
